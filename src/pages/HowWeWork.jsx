            ...
            <section className="section bg-[var(--color-primary)] text-white text-center py-24 relative overflow-hidden">
                ...
                <div className="container max-w-2xl relative z-10">
                    ...
                    <p className="text-xl text-indigo-100 mb-10 font-light">
                        The first step is understanding the signal. No pitch. No pressure.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <Link to="/diagnostic" className="btn bg-white text-[var(--color-primary)] hover:bg-gray-100 shadow-xl border-0">
                            Run System Diagnostic →
                        </Link>
                        <Link to="/contact" className="btn border border-white/30 text-white hover:bg-white/10 backdrop-blur-sm">
                            Book Operator Call →
                        </Link>
                    </div>
                </div>
